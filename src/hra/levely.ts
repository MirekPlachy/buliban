 ...
 *
 * Devět levelů, strop osm panáků, žádný nekonečný režim — hra má konec.
 * Úvod je schválně pomalý: **tři levely po dvou panácích**, z toho první
 * s ukázkou a dva s ryskou. Než se přidá panák, musí hráč pochopit, že se
...
function radek(
  ...
  return {
    ...
    tolerance,
    amplituda,
    // Roste s levelem, ne s počtem panáků: tři úvodní levely mají shodně
 ...
 * zkušený hráč 40–60 % napříč hrou. Aktuálně 8 % a 50 %.
 *
 ...
 *
 * **Skok mezi L2 a L3 je záměrný, ne překlep.** Na L1–L2 svítí ryska, takže
 * hráč cíl vidí a tolerance může být přísná. Od L3 ho musí odhadnout z výšky
...
export const levely: Level[] = [
  ...
  radek(2, 2, 'A', 'valec', 0.12, 0.06, [], true),
  // První „ostrý" level: stejné zadání jako L2, ale bez rysky. Teprve tady
  // hráč poprvé sám odhaduje, kolik je v láhvi.
  radek(3, 2, 'A', 'valec', 0.224, 0.07),
  radek(4, 3, 'B', 'valec', 0.258, 0.08),
  radek(5, 4, 'C', 'konicky', 0.278, 0.09),
  radek(6, 5, 'D', 'brichaty', 0.282, 0.1),
  radek(7, 6, 'E', 'kalisek', 0.282, 0.12, ['host-odnese']),
  radek(8, 7, 'F', 'valec', 0.271, 0.14, ['host-odnese']),
  ...
  radek(9, 8, 'G', 'valec', 0.698, 0.15, ['slepe']),
];
